...
export default function Layout({ preview, children, isHome }) {
  ...
  return (
    <>
      <Meta />
      <div id="#" className="bg-yellow-50 max-w-screen overflow-y-scroll min-h-screen flex flex-col">
        ...
        <main className={cn('shadow-upYellow transition shadow-upTransparent duration-300 bg-sasibg')}>
