...
export default function Layout({ preview, children, isHome }) {
  ...
  return (
    <>
      <Meta />
      <div id="#" className="bg-gray-800 max-w-screen overflow-y-scroll min-h-screen flex flex-col">
        <section className="text-white font-faster flex justify-center items-center text-center flex-col pt-16 pb-12">
          <div className="hidden w-20 mb-6">
          ...
          <div>
            <h1 className="text-4xl lg:text-6xl uppercase tracking-widest">{CONST_MYNAME}</h1>
            <div className="mx-auto w-64 mt-8 text-4xl">{CONST_MESSAGE}</div>
          </div>
        </section>
        <nav className="">
          <Nav />
        </nav>
        <main className={cn('shadow-up bg-sasibg')}>
