...
export default function Button({path, label, iconStyle, iconName}) {
    return(
    <Link href={path}>
      <a className="inline-block mr-0 md:mr-4 last:mr-0 my-1 md:my-4 no-underline py-3 px-4 border-2 transition duration-300 border-gray-100 hover:border-gray-500 rounded-lg">
